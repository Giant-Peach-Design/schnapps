...
class Footer extends CompatabilityBlock
{
  ...
  public function __construct()
  {
    ...
    $this->logo = wp_get_attachment_image_url(
      get_field("footer_logo", "option"),
      "full",
    );
    $this->navigation = $this->getFooterNav("footer");
    $this->socials = render_block(
      parse_blocks(
        '<!-- wp:giantpeach/sociallinks {"name":"giantpeach/sociallinks"} /-->',
      )[0],
    );
